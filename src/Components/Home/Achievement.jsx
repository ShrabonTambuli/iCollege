            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-2 mt-14">
                <div className="card w-96 h-96 bg-base-100 shadow-xl">
                    <figure className="px-10 pt-10">
                        <img src="/image/star.jpg" alt="Shoes" className="rounded-xl" />
                    </figure>
                ...
                <div className="card w-96 h-96 bg-base-100 shadow-xl">
                    <figure className="px-10 pt-10">
                        <img src="/image/ascer.jpg" alt="Shoes" className="rounded-xl" />
                    </figure>
                    <div className="card-body items-center text-center">
                ...
                <div className="card w-96 h-96 bg-base-100 shadow-xl">
                    <figure className="px-10 pt-10">
                        <img src="/image/success.avif" alt="Shoes" className="rounded-xl" />
                    </figure>
                    <div className="card-body items-center text-center">
