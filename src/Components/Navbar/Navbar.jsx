...
const Navbar = () => {
    ...
    return (
        <>
            <div className="navbar fixed z-50 bg-opacity-40 bg-[#467a7a] font-semibold text-black px-10 top-0">
                <div className="navbar-start">
                    ...
                    <div className="flex">
                        <p className="ms-2 text-xl text-center font-serif font-semibold">iCollege</p>
                    </div>
                </div>
